...
import 'package:axiom/src/application/di/services/get_jar_balance_service_provider.dart';
...
void main() {
  group('getJarBalanceService provider', () {
    test('resolves the jar balance service', () {
      ...
      final service = container.read(getJarBalanceServiceProvider);

      expect(service, isA<GetJarBalanceService>());
    });
  });
}
