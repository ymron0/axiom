...
import 'package:axiom/src/features/transactions/di/get_transaction_series_use_case_provider.dart';
...
void main() {
  group('getTransactionSeriesUseCase provider', () {
    test('resolves get-transaction-series use case', () {
      // Given
      ...
      // When
      final useCase = container.read(getTransactionSeriesUseCaseProvider);

      // Then
      expect(useCase, isA<GetTransactionSeriesUseCase>());
    });
  });
}
