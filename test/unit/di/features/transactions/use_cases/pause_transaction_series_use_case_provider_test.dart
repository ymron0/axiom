...
import 'package:axiom/src/features/transactions/di/pause_transaction_series_use_case_provider.dart';
...
void main() {
  group('pauseTransactionSeriesUseCase provider', () {
    test('resolves pause-transaction-series use case', () {
      // Given
      ...
      // When
      final useCase = container.read(pauseTransactionSeriesUseCaseProvider);

      // Then
      expect(useCase, isA<PauseTransactionSeriesUseCase>());
    });
  });
}
