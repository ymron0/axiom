...
import 'package:axiom/src/features/transactions/di/get_active_transaction_series_use_case_provider.dart';
...
void main() {
  group('getActiveTransactionSeriesUseCase provider', () {
    test('resolves get-active-transaction-series use case', () {
      // Given
      ...
      // When
      final useCase = container.read(getActiveTransactionSeriesUseCaseProvider);

      // Then
      expect(useCase, isA<GetActiveTransactionSeriesUseCase>());
    });
  });
}
