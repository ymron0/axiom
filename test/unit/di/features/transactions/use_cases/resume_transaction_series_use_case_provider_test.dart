...
import 'package:axiom/src/features/transactions/di/resume_transaction_series_use_case_provider.dart';
...
void main() {
  group('resumeTransactionSeriesUseCase provider', () {
    test('resolves resume-transaction-series use case', () {
      // Given
      ...
      // When
      final useCase = container.read(resumeTransactionSeriesUseCaseProvider);

      // Then
      expect(useCase, isA<ResumeTransactionSeriesUseCase>());
    });
  });
}
