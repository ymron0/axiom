...
import 'package:axiom/src/features/transactions/di/transaction_series_exist_by_merchant_id_use_case_provider.dart';
...
void main() {
  group('transactionSeriesExistByMerchantIdUseCase provider', () {
    test('resolves transaction-series-exist-by-merchant-id use case', () {
      // Given
      ...
      final useCase = container.read(
        transactionSeriesExistByMerchantIdUseCaseProvider,
      );

      // Then
      expect(useCase, isA<TransactionSeriesExistByMerchantIdUseCase>());
    });
  });
}
