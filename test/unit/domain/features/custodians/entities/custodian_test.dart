...
void main() {
  group('Custodian', () {
    ...
    test(
      'preserves an archive timestamp and reports the custodian archived',
      () {
        final archivedAt = DateTime.utc(2026, 9, 13);

        final custodian = _createCustodian(
          archivedAt: archivedAt,
          modifiedAt: archivedAt,
        );

        expect(custodian.archivedAt, same(archivedAt));
        expect(custodian.isArchived, isTrue);
      },
    );
