...
part 'unarchive_merchant_use_case_provider.g.dart';

/// Provides the use case for unarchiving a merchant.
@riverpod
UnarchiveMerchantUseCase unarchiveMerchantUseCase(Ref ref) {
  return UnarchiveMerchantUseCase(
